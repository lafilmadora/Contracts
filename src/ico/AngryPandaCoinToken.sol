...
import '/src/common/ownership/AngryPandaCoin.sol';
import '/src/common/token/ERC20.sol';
import '/src/common/SafeMath.sol';

/// @title AngryPandaCoin contract - standard ERC20 token with Short Hand Attack and approve() race condition mitigation.
contract AngryPandaCoin is SafeMath, ERC20, Ownable {
 string public name = " AngryPanda Token";
